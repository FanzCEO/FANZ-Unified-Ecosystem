# Guyz Database - Supabase Deployment Guide
...
2. **Execute the Complete Schema**
   - Click **"New Query"**
   - Open the file: `/tmp/GuyzV1/database/complete-schema.sql`
...
Update your `/tmp/GuyzV1/.env` file:
...
Your GuyzV1 project uses Drizzle ORM. After manual SQL deployment:
...
VALUES ('admin', 'admin@Guyz.com', '$2a$10$...', true, true);
...
**Schema File**: `/tmp/GuyzV1/database/complete-schema.sql`
**Total Lines**: 3,477
