...
class GuyzOfflineStorage {
  private db: IDBDatabase | null = null;
  private readonly dbName = 'GuyzPWA';
  ...
  async initDB(): Promise<void> {
    return new Promise((resolve, reject) => {
      ...
      request.onsuccess = () => {
        ...
        console.log('✅ Guyz IndexedDB initialized');
        resolve();
      };
...
export const offlineStorage = new GuyzOfflineStorage();
