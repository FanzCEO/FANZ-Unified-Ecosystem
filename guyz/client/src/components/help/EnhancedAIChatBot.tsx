  ...
  useEffect(() => {
    if (isOpen && messages.length === 0) {
      const welcomeMessage: ChatMessage = {
        id: 'welcome',
        type: 'bot',
        content: initialMessage || "Hi! I'm your AI assistant. I can help you find information, guide you through tutorials, or assist with any questions about Guyz. What would you like to know?",
        timestamp: new Date(),
        metadata: {
          confidence: 1.0,
          suggestedActions: [
