...
## TL;DR - Guyz Platform Backend (FANZ Ecosystem)

**Guyz-3** is a production-ready Node.js/TypeScript backend serving the Guyz adult content creator platform (`Guyz.com`). Built as part of the FANZ Unlimited Network ecosystem with API Gateway, multi-cloud infrastructure, adult-friendly payment processing, real-time monitoring, and mobile backend (ClubCentral app) support.
...
```
[Web/App (Guyz)]  [FanzClub/ClubCentral]  [Creator Studio]  [Fan Dash]
                \         |                    |                /
                              [ API Gateway / Edge ]
                                       |
                            [ Feature Flags / AB ]
...
- **Guyz**: `Guyz.com` (primary platform)
...
OTEL_SERVICE_NAME=Guyz-web
OTEL_EXPORTER_OTLP_ENDPOINT=https://otel-collector.example.com:4317

# Storage & CDN
CDN_BASE=https://cdn.Guyz.com
STORAGE_BUCKET=Guyz-media
...
export OTEL_SERVICE_NAME="Guyz-web"
...
- **Developer APIs**: https://developers.Guyz.com
- **Status Monitoring**: https://status.Guyz.com
