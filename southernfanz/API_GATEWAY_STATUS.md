...
#### Core Platforms
- **SouthernFanz** (`SouthernFanz.com`) - Port 5001 - Men's content platform
...
SouthernFanz_SERVICE_URL=http://localhost:5001
...
#### Platform Routes
- `/api/SouthernFanz/*` → SouthernFanz service
...
### SouthernFanz Server Integration
The gateway is integrated into the main SouthernFanz server via:
...
### Local Development
1. Start SouthernFanz server: `npm run dev`
...
🌐 **Multi-Platform**: Support for all FANZ platforms (SouthernFanz, GirlFanz, etc.)  
