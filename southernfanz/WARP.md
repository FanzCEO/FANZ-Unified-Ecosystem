...
## TL;DR - SouthernFanz Platform Backend (FANZ Ecosystem)

**SouthernFanz-3** is a production-ready Node.js/TypeScript backend serving the SouthernFanz adult content creator platform (`SouthernFanz.com`). Built as part of the FANZ Unlimited Network ecosystem with API Gateway, multi-cloud infrastructure, adult-friendly payment processing, real-time monitoring, and mobile backend (ClubCentral app) support.
...
```
[Web/App (SouthernFanz)]  [FanzClub/ClubCentral]  [Creator Studio]  [Fan Dash]
                \         |                    |                /
                              [ API Gateway / Edge ]
                                       |
                            [ Feature Flags / AB ]
...
- **SouthernFanz**: `SouthernFanz.com` (primary platform)
...
OTEL_SERVICE_NAME=SouthernFanz-web
OTEL_EXPORTER_OTLP_ENDPOINT=https://otel-collector.example.com:4317

# Storage & CDN
CDN_BASE=https://cdn.SouthernFanz.com
STORAGE_BUCKET=SouthernFanz-media
...
export OTEL_SERVICE_NAME="SouthernFanz-web"
...
### Required Ad Placements (SouthernFanz)
```bash
...
- **Developer APIs**: https://developers.SouthernFanz.com
- **Status Monitoring**: https://status.SouthernFanz.com
