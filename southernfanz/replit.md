# SouthernFanz-3 - FANZ Unlimited Network Ecosystem

## Overview

SouthernFanz-3 is the flagship platform of the FANZ Unlimited Network, a multi-platform adult content creator economy ecosystem. This Node.js/TypeScript backend powers SouthernFanz.com and serves as the foundation for the broader FANZ network, which includes GirlFanz, PupFanz, TransFanz, and TabooFanz platforms.
...
- SouthernFanz (Port 5001) - Men's content platform
...
2. Configure custom domain DNS:
   - Testing: `fanz.SouthernFanz.com`
   - Production: `SouthernFanz.com`
...
- ✅ **Kubernetes Configs** - Full k8s deployment for Digital Ocean:
  - Deployments for all 5 platforms (SouthernFanz, GirlFanz, PupFanz, TransFanz, TabooFanz)
