# SouthernFanzV1 Deployment Fix Summary
**Date**: 2025-11-01
...
- Cloned from GitHub: `FanzCEO/SouthernFanzV1`
...
```yaml
databases:
  - name: SouthernFanz-db
    databaseName: SouthernFanz_production
    user: SouthernFanz_user
```
...
### Render
- **App**: `https://SouthernFanz-v1.onrender.com` (auto-generated)
