...
#### Core Platforms
- **FanzUncut** (`FanzUncut.com`) - Port 5001 - Men's content platform
...
FanzUncut_SERVICE_URL=http://localhost:5001
...
#### Platform Routes
- `/api/FanzUncut/*` → FanzUncut service
...
### FanzUncut Server Integration
The gateway is integrated into the main FanzUncut server via:
...
### Local Development
1. Start FanzUncut server: `npm run dev`
...
🌐 **Multi-Platform**: Support for all FANZ platforms (FanzUncut, GirlFanz, etc.)  
