# FanzUncutV1 Deployment Fix Summary
**Date**: 2025-11-01
...
- Cloned from GitHub: `FanzCEO/FanzUncutV1`
...
databases:
  - name: FanzUncut-db
    databaseName: FanzUncut_production
    user: FanzUncut_user
```
...
### Render
- **App**: `https://FanzUncut-v1.onrender.com` (auto-generated)
