...
Pick one platform to start with (recommend **FanzUncut** for the dark theme):
```bash
./start-FanzUncut.sh
...
### **Frontend:**
- Start with one platform (FanzUncut recommended)
