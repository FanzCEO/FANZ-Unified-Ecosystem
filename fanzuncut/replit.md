# FanzUncut-3 - FANZ Unlimited Network Ecosystem

## Overview

FanzUncut-3 is the flagship platform of the FANZ Unlimited Network, a multi-platform adult content creator economy ecosystem. This Node.js/TypeScript backend powers FanzUncut.com and serves as the foundation for the broader FANZ network, which includes GirlFanz, PupFanz, TransFanz, and TabooFanz platforms.
...
- FanzUncut (Port 5001) - Men's content platform
...
2. Configure custom domain DNS:
   - Testing: `fanz.FanzUncut.com`
   - Production: `FanzUncut.com`
...
- ✅ **Kubernetes Configs** - Full k8s deployment for Digital Ocean:
  - Deployments for all 5 platforms (FanzUncut, GirlFanz, PupFanz, TransFanz, TabooFanz)
