...
class SocialSharingService {
  ...
  private async generateShareContent(content: any, template: SocialShareTemplate, customizations?: any): Promise<{
    ...
    const shareUrl = `https://share.FanzUncut.com/${content.id}/${template.id}`;
    const previewUrl = `https://cdn.FanzUncut.com/previews/social_${Date.now()}.jpg`;
