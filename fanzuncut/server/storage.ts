...
export class DatabaseStorage implements IStorage {
  ...
  async anonymizeUserData(userId: string): Promise<void> {
    ...
    await db.update(users)
      .set({
        email: `deleted_user_${userId}@FanzUncut.com`,
  ...
  async getSystemSetting(key: string): Promise<any | undefined> {
    ...
    const settings: { [key: string]: any } = {
      'app_name': { key: 'app_name', value: 'FanzUncut', type: 'string' },
  ...
  async getEmailSettings(): Promise<any> {
    return {
      ...
      smtpPort: 587,
      smtpUsername: 'noreply@FanzUncut.com',
      smtpPassword: '****',
      smtpSecure: true,
      fromEmail: 'noreply@FanzUncut.com',
      fromName: 'FanzUncut',
      replyToEmail: 'support@FanzUncut.com',
      maxSendRate: 100,
      isActive: true,
