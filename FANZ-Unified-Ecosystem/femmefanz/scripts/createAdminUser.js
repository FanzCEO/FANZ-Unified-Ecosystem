...
class AdminUserManager {
  ...
  async createAdminUser(userData) {
    try {
      ...
      const adminData = {
        email: userData.email || 'admin@FemmeFanz.com',
  ...
  adminManager.runFullTest()
    .then(result => {
      if (result.success) {
        ...
        console.log(`📧 Admin Email: admin@FemmeFanz.com`);
