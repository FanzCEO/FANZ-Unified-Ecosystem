...
const FROM_EMAIL = 'FemmeFanz <onboarding@resend.dev>'; // Change to your verified domain
  ...
  async sendVerificationEmail(email: string, token: string): Promise<void> {
    ...
    const html = `
      ...
      <html>
        ...
        <body>
          ...
          <div class="footer">
            <p>If you didn't create an account with FemmeFanz, you can safely ignore this email.</p>
            <p>&copy; ${new Date().getFullYear()} FemmeFanz. All rights reserved.</p>
          </div>
        </body>
      </html>
    `;
    ...
    try {
      await resend.emails.send({
        from: FROM_EMAIL,
        to: email,
        subject: 'Verify your FemmeFanz account',
        html,
      });
  ...
  async sendPasswordResetEmail(email: string, token: string): Promise<void> {
    ...
    try {
      await resend.emails.send({
        from: FROM_EMAIL,
        to: email,
        subject: 'Reset your FemmeFanz password',
        html,
      });
