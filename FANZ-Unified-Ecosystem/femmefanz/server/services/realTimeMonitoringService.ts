...
export class MetricsCollector extends EventEmitter {
  ...
  private getPlatformHealthUrl(platformId: string): string {
    ...
    const urlMap: Record<string, string> = {
      'FemmeFanz': process.env.FemmeFanz_HEALTH_URL || 'http://localhost:5000/health',
...
export const MonitoringConfigSchema = z.object({
  ...
  platforms: z.array(z.string()).default(['FemmeFanz', 'girlfanz', 'pupfanz', 'transfanz', 'taboofanz']),
