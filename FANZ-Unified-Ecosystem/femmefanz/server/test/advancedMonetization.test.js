...
async function testPayPerViewContent() {
  ...
  try {
    ...
    const premiumVideoData = {
      ...
      contentType: 'VIDEO',
      mediaUrl: 'https://cdn.FemmeFanz.com/content/exclusive-bts-photoshoot-2024.mp4',
      thumbnailUrl: 'https://cdn.FemmeFanz.com/thumbnails/bts-photoshoot-thumb.jpg',
      pricing: {
        amount: 24.99,
        currency: 'USD',
    ...
    const photoSetData = {
      ...
      mediaUrl: 'https://cdn.FemmeFanz.com/photosets/beach-vacation-2024/',
      thumbnailUrl: 'https://cdn.FemmeFanz.com/thumbnails/beach-vacation-preview.jpg',
      pricing: {
        amount: 15.99,
        currency: 'USD',
    ...
    const liveStreamData = {
      ...
      mediaUrl: 'https://stream.FemmeFanz.com/live/private-qa-session',
      thumbnailUrl: 'https://cdn.FemmeFanz.com/thumbnails/live-stream-qa.jpg',
      pricing: {
        amount: 49.99,
        currency: 'USD',
...
async function testMerchandiseStore() {
  ...
  try {
    const storeData = {
      ...
      branding: {
        logo: 'https://cdn.FemmeFanz.com/stores/jake-official-logo.png',
        bannerImage: 'https://cdn.FemmeFanz.com/stores/jake-store-banner.jpg',
        colorScheme: {
          primary: '#FF6B35',
          secondary: '#F7931E',
          accent: '#FFD23F'
    ...
    const products = [
      {
        ...
        type: 'PHYSICAL',
        images: [
          'https://cdn.FemmeFanz.com/products/logo-tshirt-black.jpg',
          'https://cdn.FemmeFanz.com/products/logo-tshirt-white.jpg',
          'https://cdn.FemmeFanz.com/products/logo-tshirt-navy.jpg'
        ],
        pricing: {
          basePrice: 24.99,
          salePrice: null,
      ...
      },
      {
        ...
        type: 'PHYSICAL',
        images: ['https://cdn.FemmeFanz.com/products/signed-print-limited.jpg'],
        pricing: {
          basePrice: 49.99,
          salePrice: 39.99,
          currency: 'USD',
      ...
      },
      {
        ...
        type: 'DIGITAL',
        images: ['https://cdn.FemmeFanz.com/products/digital-video-bundle.jpg'],
        pricing: {
          basePrice: 89.99,
          salePrice: null,
          currency: 'USD',
