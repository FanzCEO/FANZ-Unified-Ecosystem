...
## Overview
ClubCentral is the official mobile app for the FANZ Unlimited Network, providing access to BearFanz, GirlFanz, PupFanz, TransFanz, and TabooFanz platforms through a unified mobile experience.
...
```javascript
const FANZ_CONFIG = {
  baseUrl: 'https://api.BearFanz.com/api/mobile', // Production
...
```bash
# Production URLs
API_BASE_URL=https://api.BearFanz.com/api
WS_BASE_URL=wss://api.BearFanz.com
...
interface UserProfile {
  ...
  email: string;
  avatar: string;
  platforms: string[]; // ['BearFanz', 'girlfanz', etc.]
  verified: boolean;
  createdAt: string;
  lastActive: string;
}
...
interface ContentFeed {
  posts: Array<{
    ...
    createdAt: string;
    platform: string; // 'BearFanz', 'girlfanz', etc.
  }>;
  pagination: {
    page: number;
    limit: number;
...
interface AppConfig {
  ...
  platforms: {
    BearFanz: { enabled: boolean; baseUrl: string };
...
class FanzAPIClient {
    private let baseURL = "https://api.BearFanz.com/api/mobile"
...
- **API Documentation**: [https://docs.BearFanz.com/mobile](https://docs.BearFanz.com/mobile)
- **Developer Portal**: [https://developers.BearFanz.com](https://developers.BearFanz.com)
- **Status Page**: [https://status.BearFanz.com](https://status.BearFanz.com)
- **Support Email**: developers@BearFanz.com
