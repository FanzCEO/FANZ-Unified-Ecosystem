      ...
      <section className="py-24" aria-label="Call to action" role="region">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-2xl mb-8 font-body seedy-neon-white">
            Join thousands of creators who are already building their empire on <span className="font-display font-black seedy-neon-golden tracking-wide">SouthernFanz</span>.
          </p>
          <Button 
            onClick={handleLogin} 
            size="lg" 
