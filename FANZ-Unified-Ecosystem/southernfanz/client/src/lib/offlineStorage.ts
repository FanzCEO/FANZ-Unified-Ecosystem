// SouthernFanz PWA Offline Storage
...
class SouthernFanzOfflineStorage {
  private db: IDBDatabase | null = null;
  private readonly dbName = 'SouthernFanzPWA';
  ...
  async initDB(): Promise<void> {
    return new Promise((resolve, reject) => {
      ...
      request.onsuccess = () => {
        ...
        console.log('✅ SouthernFanz IndexedDB initialized');
        resolve();
      };
...
export const offlineStorage = new SouthernFanzOfflineStorage();
