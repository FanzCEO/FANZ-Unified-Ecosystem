...
class SouthernFanzPWAManager {
  ...
  async init(): Promise<void> {
    try {
      ...
      console.log('🚀 SouthernFanz PWA Manager initialized successfully');
    } catch (error) {
...
export const pwaManager = new SouthernFanzPWAManager();
