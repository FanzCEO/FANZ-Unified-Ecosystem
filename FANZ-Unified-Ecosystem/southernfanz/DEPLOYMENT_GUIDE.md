...
Complete guide to deploying the SouthernFanz, GirlFanz, PupFanz, TransFanz, and TabooFanz platforms to Digital Ocean Kubernetes.
...
For **each domain** (SouthernFanz.com, girlfanz.com, etc.), add these DNS records:
...
kubectl delete certificate SouthernFanz-tls -n fanz-ecosystem
kubectl apply -f k8s/ingress/ingress.yaml
```
...
kubectl rollout history deployment/SouthernFanz -n fanz-ecosystem

# Rollback to previous version
kubectl rollout undo deployment/SouthernFanz -n fanz-ecosystem

# Rollback to specific revision
kubectl rollout undo deployment/SouthernFanz --to-revision=2 -n fanz-ecosystem
```
...
- **GitHub Repository**: https://github.com/FanzCEO/SouthernFanzV1
