...
- PostgreSQL database
- Redis cache
- All 5 platforms (SouthernFanz, GirlFanz, PupFanz, TransFanz, TabooFanz)
- NGINX load balancer
...
- `k8s/deployments/SouthernFanz-deployment.yaml` - 3 replicas
...
#### **Services** (ClusterIP)
- `k8s/services/SouthernFanz-service.yaml`
...
┌─────────────────────────────────────────────────────┐
│                 Load Balancer (NGINX)               │
│            SouthernFanz.com, girlfanz.com, etc.          │
└────────────────────┬────────────────────────────────┘
                     │
            ┌────────┴────────┐
            │   Kubernetes    │
    ...
    ▼                ▼                ▼
┌─────────┐    ┌─────────┐      ┌─────────┐
│ SouthernFanz │    │GirlFanz │ ...  │TabooFanz│
...
- GitHub: https://github.com/FanzCEO/SouthernFanzV1
