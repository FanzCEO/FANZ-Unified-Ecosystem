...
class DLBrozOfflineStorage {
  private db: IDBDatabase | null = null;
  private readonly dbName = 'DLBrozPWA';
  ...
  async initDB(): Promise<void> {
    return new Promise((resolve, reject) => {
      ...
      request.onsuccess = () => {
        ...
        console.log('✅ DLBroz IndexedDB initialized');
        resolve();
      };
...
export const offlineStorage = new DLBrozOfflineStorage();
