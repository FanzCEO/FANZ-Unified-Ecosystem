...
- 5 registered domains (GayFanz.com, girlfanz.com, pupfanz.com, transfanz.com, taboofanz.com)
...
|--------|------|------|-------|
| GayFanz.com | A | @ | `<LOAD_BALANCER_IP>` |
| GayFanz.com | A | www | `<LOAD_BALANCER_IP>` |
...
- **GitHub Issues**: https://github.com/FanzCEO/GayFanzV1/issues
