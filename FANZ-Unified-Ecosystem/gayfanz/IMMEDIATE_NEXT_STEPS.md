...
Pick one platform to start with (recommend **GayFanz** for the dark theme):
```bash
./start-GayFanz.sh
...
### **Frontend:**
- Start with one platform (GayFanz recommended)
