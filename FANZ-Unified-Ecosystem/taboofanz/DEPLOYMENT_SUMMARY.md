...
- PostgreSQL database
- Redis cache
- All 5 platforms (TabooFanz, GirlFanz, PupFanz, TransFanz, TabooFanz)
- NGINX load balancer
...
- `k8s/deployments/TabooFanz-deployment.yaml` - 3 replicas
...
┌─────────────────────────────────────────────────────┐
│                 Load Balancer (NGINX)               │
│            TabooFanz.com, girlfanz.com, etc.          │
└────────────────────┬────────────────────────────────┘
                     │
            ┌────────┴────────┐
            │   Kubernetes    │
...
- GitHub: https://github.com/FanzCEO/TabooFanzV1
