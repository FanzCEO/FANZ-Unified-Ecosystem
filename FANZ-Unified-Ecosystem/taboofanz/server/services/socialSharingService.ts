...
class SocialSharingService {
  ...
  private async generateShareContent(content: any, template: SocialShareTemplate, customizations?: any): Promise<{
    ...
    const shareUrl = `https://share.TabooFanz.com/${content.id}/${template.id}`;
    const previewUrl = `https://cdn.TabooFanz.com/previews/social_${Date.now()}.jpg`;
