# TabooFanz Database - Supabase Deployment Guide
...
2. **Execute the Complete Schema**
   - Click **"New Query"**
   - Open the file: `/tmp/TabooFanzV1/database/complete-schema.sql`
...
Update your `/tmp/TabooFanzV1/.env` file:
...
Your TabooFanzV1 project uses Drizzle ORM. After manual SQL deployment:
...
VALUES ('admin', 'admin@TabooFanz.com', '$2a$10$...', true, true);
...
- TabooFanzV1 Repo: https://github.com/FanzCEO/TabooFanzV1

---

## Deployment Status

**Schema File**: `/tmp/TabooFanzV1/database/complete-schema.sql`
**Total Lines**: 3,477
