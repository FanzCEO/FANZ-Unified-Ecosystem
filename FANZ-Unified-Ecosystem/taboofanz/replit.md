# TabooFanz-3 - FANZ Unlimited Network Ecosystem

## Overview

TabooFanz-3 is the flagship platform of the FANZ Unlimited Network, a multi-platform adult content creator economy ecosystem. This Node.js/TypeScript backend powers TabooFanz.com and serves as the foundation for the broader FANZ network, which includes GirlFanz, PupFanz, TransFanz, and TabooFanz platforms.
...
- TabooFanz (Port 5001) - Men's content platform
...
2. Configure custom domain DNS:
   - Testing: `fanz.TabooFanz.com`
   - Production: `TabooFanz.com`
...
- ✅ **Kubernetes Configs** - Full k8s deployment for Digital Ocean:
  - Deployments for all 5 platforms (TabooFanz, GirlFanz, PupFanz, TransFanz, TabooFanz)
