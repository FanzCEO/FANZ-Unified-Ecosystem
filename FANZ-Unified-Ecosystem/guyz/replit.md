# Guyz-3 - FANZ Unlimited Network Ecosystem

## Overview

Guyz-3 is the flagship platform of the FANZ Unlimited Network, a multi-platform adult content creator economy ecosystem. This Node.js/TypeScript backend powers Guyz.com and serves as the foundation for the broader FANZ network, which includes GirlFanz, PupFanz, TransFanz, and TabooFanz platforms.
...
- Guyz (Port 5001) - Men's content platform
...
- ✅ **Kubernetes Configs** - Full k8s deployment for Digital Ocean:
  - Deployments for all 5 platforms (Guyz, GirlFanz, PupFanz, TransFanz, TabooFanz)
