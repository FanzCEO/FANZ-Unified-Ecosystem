...
export default function AIChatBot() {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: '1',
      content: 'Welcome to Guyz AI Assistant! I can help you with platform questions, tutorials, and walkthroughs. What would you like to know?',
      sender: 'ai',
      timestamp: new Date()
    }
  ]);
  ...
  const handleQuickAction = (action: string) => {
    ...
    switch (action) {
      case 'help':
        message = 'How can I help you with the Guyz platform?';
        break;
      case 'wiki':
