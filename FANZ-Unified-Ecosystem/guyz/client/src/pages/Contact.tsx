...
const FAQ = () => {
  const faqs = [
    ...
    },
    {
      ...
      answer: "Guyz operates on a 100% creator earnings program - we take 0% platform fees. You only pay standard payment processing fees (around 2.9%)."
    },
    {
