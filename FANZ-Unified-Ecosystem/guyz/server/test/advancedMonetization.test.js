...
async function testPayPerViewContent() {
  ...
  try {
    ...
    const premiumVideoData = {
      ...
      contentType: 'VIDEO',
      mediaUrl: 'https://cdn.Guyz.com/content/exclusive-bts-photoshoot-2024.mp4',
      thumbnailUrl: 'https://cdn.Guyz.com/thumbnails/bts-photoshoot-thumb.jpg',
      pricing: {
        amount: 24.99,
        currency: 'USD',
    ...
    const photoSetData = {
      ...
      mediaUrl: 'https://cdn.Guyz.com/photosets/beach-vacation-2024/',
      thumbnailUrl: 'https://cdn.Guyz.com/thumbnails/beach-vacation-preview.jpg',
      pricing: {
        amount: 15.99,
        currency: 'USD',
    ...
    const liveStreamData = {
      ...
      mediaUrl: 'https://stream.Guyz.com/live/private-qa-session',
      thumbnailUrl: 'https://cdn.Guyz.com/thumbnails/live-stream-qa.jpg',
      pricing: {
        amount: 49.99,
        currency: 'USD',
...
async function testMerchandiseStore() {
  ...
  try {
    const storeData = {
      ...
      branding: {
        logo: 'https://cdn.Guyz.com/stores/jake-official-logo.png',
        bannerImage: 'https://cdn.Guyz.com/stores/jake-store-banner.jpg',
        colorScheme: {
          primary: '#FF6B35',
          secondary: '#F7931E',
          accent: '#FFD23F'
    ...
    const products = [
      {
        ...
        type: 'PHYSICAL',
        images: [
          'https://cdn.Guyz.com/products/logo-tshirt-black.jpg',
          'https://cdn.Guyz.com/products/logo-tshirt-white.jpg',
          'https://cdn.Guyz.com/products/logo-tshirt-navy.jpg'
        ],
        pricing: {
          basePrice: 24.99,
          salePrice: null,
      ...
      },
      {
        ...
        type: 'PHYSICAL',
        images: ['https://cdn.Guyz.com/products/signed-print-limited.jpg'],
        pricing: {
          basePrice: 49.99,
          salePrice: 39.99,
          currency: 'USD',
      ...
      },
      {
        ...
        type: 'DIGITAL',
        images: ['https://cdn.Guyz.com/products/digital-video-bundle.jpg'],
        pricing: {
          basePrice: 89.99,
          salePrice: null,
          currency: 'USD',
