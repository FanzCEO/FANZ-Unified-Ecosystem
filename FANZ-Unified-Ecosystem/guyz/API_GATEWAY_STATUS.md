...
#### Core Platforms
- **Guyz** (`Guyz.com`) - Port 5001 - Men's content platform
...
Guyz_SERVICE_URL=http://localhost:5001
...
### Guyz Server Integration
The gateway is integrated into the main Guyz server via:
...
### Local Development
1. Start Guyz server: `npm run dev`
...
🌐 **Multi-Platform**: Support for all FANZ platforms (Guyz, GirlFanz, etc.)  
