...
class TransFanzPWAManager {
  ...
  async init(): Promise<void> {
    try {
      ...
      console.log('🚀 TransFanz PWA Manager initialized successfully');
    } catch (error) {
...
export const pwaManager = new TransFanzPWAManager();
