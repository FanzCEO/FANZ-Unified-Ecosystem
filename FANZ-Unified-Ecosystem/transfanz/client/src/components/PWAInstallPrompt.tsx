// TransFanz PWA Installation Prompt Component
// Custom installation prompt with TransFanz underground aesthetic
  ...
  const handleInstall = async () => {
    ...
    try {
      ...
      if (success) {
        ...
        console.log('🎉 TransFanz PWA installed successfully');
      }
    } catch (error) {
