...
- PostgreSQL database
- Redis cache
- All 5 platforms (TransFanz, GirlFanz, PupFanz, TransFanz, TabooFanz)
- NGINX load balancer
...
- `k8s/deployments/TransFanz-deployment.yaml` - 3 replicas
...
┌─────────────────────────────────────────────────────┐
│                 Load Balancer (NGINX)               │
│            TransFanz.com, girlfanz.com, etc.          │
└────────────────────┬────────────────────────────────┘
                     │
            ┌────────┴────────┐
            │   Kubernetes    │
...
- GitHub: https://github.com/FanzCEO/TransFanzV1
