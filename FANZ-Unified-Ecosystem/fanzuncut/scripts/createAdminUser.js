...
class AdminUserManager {
  ...
  async createAdminUser(userData) {
    try {
      ...
      const adminData = {
        email: userData.email || 'admin@FanzUncut.com',
  ...
  adminManager.runFullTest()
    .then(result => {
      if (result.success) {
        ...
        console.log(`📧 Admin Email: admin@FanzUncut.com`);
