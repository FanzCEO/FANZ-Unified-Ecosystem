...
- 5 registered domains (FanzUncut.com, girlfanz.com, pupfanz.com, transfanz.com, taboofanz.com)
...
|--------|------|------|-------|
| FanzUncut.com | A | @ | `<LOAD_BALANCER_IP>` |
| FanzUncut.com | A | www | `<LOAD_BALANCER_IP>` |
...
- **GitHub Issues**: https://github.com/FanzCEO/FanzUncutV1/issues
