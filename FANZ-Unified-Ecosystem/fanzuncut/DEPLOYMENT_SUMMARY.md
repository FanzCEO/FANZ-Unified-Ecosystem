...
- PostgreSQL database
- Redis cache
- All 5 platforms (FanzUncut, GirlFanz, PupFanz, TransFanz, TabooFanz)
- NGINX load balancer
...
- `k8s/deployments/FanzUncut-deployment.yaml` - 3 replicas
...
#### **Services** (ClusterIP)
- `k8s/services/FanzUncut-service.yaml`
...
┌─────────────────────────────────────────────────────┐
│                 Load Balancer (NGINX)               │
│            FanzUncut.com, girlfanz.com, etc.          │
└────────────────────┬────────────────────────────────┘
                     │
            ┌────────┴────────┐
            │   Kubernetes    │
...
- GitHub: https://github.com/FanzCEO/FanzUncutV1
