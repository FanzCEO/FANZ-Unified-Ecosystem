...
class FanzUncutOfflineStorage {
  private db: IDBDatabase | null = null;
  private readonly dbName = 'FanzUncutPWA';
  ...
  async initDB(): Promise<void> {
    return new Promise((resolve, reject) => {
      ...
      request.onsuccess = () => {
        ...
        console.log('✅ FanzUncut IndexedDB initialized');
        resolve();
      };
...
export const offlineStorage = new FanzUncutOfflineStorage();
