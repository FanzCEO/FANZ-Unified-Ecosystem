...
class FanzUncutPWAManager {
  ...
  async init(): Promise<void> {
    try {
      ...
      console.log('🚀 FanzUncut PWA Manager initialized successfully');
    } catch (error) {
...
export const pwaManager = new FanzUncutPWAManager();
