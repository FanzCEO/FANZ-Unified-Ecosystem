# FanzUncut Database - Supabase Deployment Guide
...
2. **Execute the Complete Schema**
   - Click **"New Query"**
   - Open the file: `/tmp/FanzUncutV1/database/complete-schema.sql`
...
Update your `/tmp/FanzUncutV1/.env` file:
...
Your FanzUncutV1 project uses Drizzle ORM. After manual SQL deployment:
...
VALUES ('admin', 'admin@FanzUncut.com', '$2a$10$...', true, true);
...
- FanzUncutV1 Repo: https://github.com/FanzCEO/FanzUncutV1

---

## Deployment Status

**Schema File**: `/tmp/FanzUncutV1/database/complete-schema.sql`
**Total Lines**: 3,477
