...
## TL;DR - GayFanz Platform Backend (FANZ Ecosystem)

**GayFanz-3** is a production-ready Node.js/TypeScript backend serving the GayFanz adult content creator platform (`GayFanz.com`). Built as part of the FANZ Unlimited Network ecosystem with API Gateway, multi-cloud infrastructure, adult-friendly payment processing, real-time monitoring, and mobile backend (ClubCentral app) support.
...
```
[Web/App (GayFanz)]  [FanzClub/ClubCentral]  [Creator Studio]  [Fan Dash]
                \         |                    |                /
                              [ API Gateway / Edge ]
                                       |
                            [ Feature Flags / AB ]
...
- **GayFanz**: `GayFanz.com` (primary platform)
...
OTEL_SERVICE_NAME=GayFanz-web
OTEL_EXPORTER_OTLP_ENDPOINT=https://otel-collector.example.com:4317

# Storage & CDN
CDN_BASE=https://cdn.GayFanz.com
STORAGE_BUCKET=GayFanz-media
...
export OTEL_SERVICE_NAME="GayFanz-web"
...
### Required Ad Placements (GayFanz)
```bash
...
- **Developer APIs**: https://developers.GayFanz.com
- **Status Monitoring**: https://status.GayFanz.com
