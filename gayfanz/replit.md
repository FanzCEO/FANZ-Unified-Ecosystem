# GayFanz-3 - FANZ Unlimited Network Ecosystem

## Overview

GayFanz-3 is the flagship platform of the FANZ Unlimited Network, a multi-platform adult content creator economy ecosystem. This Node.js/TypeScript backend powers GayFanz.com and serves as the foundation for the broader FANZ network, which includes GirlFanz, PupFanz, TransFanz, and TabooFanz platforms.
...
- GayFanz (Port 5001) - Men's content platform
...
2. Configure custom domain DNS:
   - Testing: `fanz.GayFanz.com`
   - Production: `GayFanz.com`
...
- ✅ **Kubernetes Configs** - Full k8s deployment for Digital Ocean:
  - Deployments for all 5 platforms (GayFanz, GirlFanz, PupFanz, TransFanz, TabooFanz)
