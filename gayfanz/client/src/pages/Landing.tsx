...
export default function Landing() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground homepage-bg" data-testid="landing-page">
      ...
      {/* Hero Section */}
      <main id="main-content" className="relative overflow-hidden" role="main" aria-label="GayFanz platform introduction">
          ...
          <div className="text-center">
            <div className="flex justify-center mb-12">
              <img 
                ...
                alt="GayFanz - Every Man's Playground logo" 
                ...
                role="img"
                data-testid="GayFanz-logo-enhanced"
              />
            </div>
      ...
      <section className="py-24" aria-label="Call to action" role="region">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-2xl mb-8 font-body seedy-neon-white">
            Join thousands of creators who are already building their empire on <span className="font-display font-black seedy-neon-golden tracking-wide">GayFanz</span>.
          </p>
          <Button 
            onClick={handleLogin} 
            size="lg" 
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="text-center mb-4">
            <p className="text-xs text-gray-500">
              © 2025 GayFanz. All rights reserved. FANZ (FANZ) L.L.C. - Address: 30 N Gould St #45302 Sheridan, Wyoming United States
            </p>
          </div>
