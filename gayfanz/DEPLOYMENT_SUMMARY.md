...
- PostgreSQL database
- Redis cache
- All 5 platforms (GayFanz, GirlFanz, PupFanz, TransFanz, TabooFanz)
- NGINX load balancer
...
- `k8s/deployments/GayFanz-deployment.yaml` - 3 replicas
...
#### **Services** (ClusterIP)
- `k8s/services/GayFanz-service.yaml`
...
- GitHub: https://github.com/FanzCEO/GayFanzV1
