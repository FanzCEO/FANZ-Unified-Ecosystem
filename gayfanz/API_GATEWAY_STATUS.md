...
#### Core Platforms
- **GayFanz** (`GayFanz.com`) - Port 5001 - Men's content platform
...
GayFanz_SERVICE_URL=http://localhost:5001
...
### GayFanz Server Integration
The gateway is integrated into the main GayFanz server via:
...
### Local Development
1. Start GayFanz server: `npm run dev`
...
🌐 **Multi-Platform**: Support for all FANZ platforms (GayFanz, GirlFanz, etc.)  
