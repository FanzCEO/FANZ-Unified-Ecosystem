...
class AdminUserManager {
  ...
  async createAdminUser(userData) {
    try {
      ...
      const adminData = {
        email: userData.email || 'admin@GayFanz.com',
  ...
  adminManager.runFullTest()
    .then(result => {
      if (result.success) {
        ...
        console.log(`📧 Admin Email: admin@GayFanz.com`);
