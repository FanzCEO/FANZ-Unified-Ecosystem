...
- PostgreSQL database
- Redis cache
- All 5 platforms (DLBroz, GirlFanz, PupFanz, TransFanz, TabooFanz)
- NGINX load balancer
...
- `k8s/deployments/DLBroz-deployment.yaml` - 3 replicas
...
#### **Services** (ClusterIP)
- `k8s/services/DLBroz-service.yaml`
...
|--------|------|------|-------|
| DLBroz.com | A | @ | `<LOAD_BALANCER_IP>` |
| DLBroz.com | A | www | `<LOAD_BALANCER_IP>` |
...
- GitHub: https://github.com/FanzCEO/DLBrozV1
