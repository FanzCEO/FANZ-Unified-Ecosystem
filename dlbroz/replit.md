# DLBroz-3 - FANZ Unlimited Network Ecosystem

## Overview

DLBroz-3 is the flagship platform of the FANZ Unlimited Network, a multi-platform adult content creator economy ecosystem. This Node.js/TypeScript backend powers DLBroz.com and serves as the foundation for the broader FANZ network, which includes GirlFanz, PupFanz, TransFanz, and TabooFanz platforms.
...
- DLBroz (Port 5001) - Men's content platform
...
2. Configure custom domain DNS:
   - Testing: `fanz.DLBroz.com`
   - Production: `DLBroz.com`
...
- ✅ **Kubernetes Configs** - Full k8s deployment for Digital Ocean:
  - Deployments for all 5 platforms (DLBroz, GirlFanz, PupFanz, TransFanz, TabooFanz)
