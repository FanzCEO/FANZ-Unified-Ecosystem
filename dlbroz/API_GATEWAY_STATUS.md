...
#### Core Platforms
- **DLBroz** (`DLBroz.com`) - Port 5001 - Men's content platform
...
DLBroz_SERVICE_URL=http://localhost:5001
...
### DLBroz Server Integration
The gateway is integrated into the main DLBroz server via:
...
### Local Development
1. Start DLBroz server: `npm run dev`
...
🌐 **Multi-Platform**: Support for all FANZ platforms (DLBroz, GirlFanz, etc.)  
