...
Pick one platform to start with (recommend **DLBroz** for the dark theme):
```bash
./start-DLBroz.sh
...
### **Frontend:**
- Start with one platform (DLBroz recommended)
