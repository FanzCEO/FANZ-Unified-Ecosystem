...
- 5 registered domains (FemmeFanz.com, girlfanz.com, pupfanz.com, transfanz.com, taboofanz.com)
...
|--------|------|------|-------|
| FemmeFanz.com | A | @ | `<LOAD_BALANCER_IP>` |
| FemmeFanz.com | A | www | `<LOAD_BALANCER_IP>` |
...
- **GitHub Issues**: https://github.com/FanzCEO/FemmeFanzV1/issues
