...
#### Core Platforms
- **FemmeFanz** (`FemmeFanz.com`) - Port 5001 - Men's content platform
...
FemmeFanz_SERVICE_URL=http://localhost:5001
...
#### Platform Routes
- `/api/FemmeFanz/*` → FemmeFanz service
...
### FemmeFanz Server Integration
The gateway is integrated into the main FemmeFanz server via:
...
### Local Development
1. Start FemmeFanz server: `npm run dev`
...
🌐 **Multi-Platform**: Support for all FANZ platforms (FemmeFanz, GirlFanz, etc.)  
