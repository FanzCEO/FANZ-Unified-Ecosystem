...
class FemmeFanzPWAManager {
  ...
  async init(): Promise<void> {
    try {
      ...
      console.log('🚀 FemmeFanz PWA Manager initialized successfully');
    } catch (error) {
...
export const pwaManager = new FemmeFanzPWAManager();
