# FemmeFanz-3 - FANZ Unlimited Network Ecosystem

## Overview

FemmeFanz-3 is the flagship platform of the FANZ Unlimited Network, a multi-platform adult content creator economy ecosystem. This Node.js/TypeScript backend powers FemmeFanz.com and serves as the foundation for the broader FANZ network, which includes GirlFanz, PupFanz, TransFanz, and TabooFanz platforms.
...
- FemmeFanz (Port 5001) - Men's content platform
...
2. Configure custom domain DNS:
   - Testing: `fanz.FemmeFanz.com`
   - Production: `FemmeFanz.com`
...
- ✅ **Kubernetes Configs** - Full k8s deployment for Digital Ocean:
  - Deployments for all 5 platforms (FemmeFanz, GirlFanz, PupFanz, TransFanz, TabooFanz)
