# FanzOSMicroservices - FANZ Ecosystem

[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)
[![Security](https://github.com/FanzCEO/FanzOSMicroservices/workflows/Security/badge.svg)](https://github.com/FanzCEO/FanzOSMicroservices/security)
...
FanzOSMicroservices is a core component of the FANZ ecosystem, built with our creator-first principles:
...
```bash
# Clone repository
git clone https://github.com/FanzCEO/FanzOSMicroservices.git
cd FanzOSMicroservices
