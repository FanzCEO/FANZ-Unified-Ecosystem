  ...
  return (
    <header className="sticky top-0 z-50 bg-ink-900/95 backdrop-blur-lg border-b border-neon-pink/20 shadow-[0_4px_20px_rgba(255,45,161,0.1)]">
      ...
      <nav className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between relative">
        ...
        <a
          href="/"
          className="font-display text-3xl font-bold tracking-flow text-soft-glow-pink animate-flicker hover:text-soft-glow-cyan transition-all duration-300 hover:scale-105 relative group"
        >
          FANZ
          <span className="absolute -inset-2 bg-neon-pink/20 blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-sexy -z-10"></span>
        ...
        {/* Mobile Menu Button */}
        <button
          className="md:hidden text-white p-2 rounded-sexy border border-neon-cyan/30 hover:border-neon-cyan hover:bg-neon-cyan/10 hover:shadow-[0_0_15px_rgba(25,240,255,0.3)] transition-all duration-300"
