    ...
    <main className="min-h-screen bg-ink-900">
      ...
      <section className="relative overflow-hidden bg-ink-900 text-white">
        ...
        <div className="max-w-7xl mx-auto px-6 py-32 relative z-10">
          <div className="text-center">
            ...
            <h1 className="font-display text-6xl md:text-9xl font-bold tracking-airy text-soft-glow-pink animate-flicker mb-6">
              FANZ
            </h1>
            <p className="text-2xl md:text-3xl text-white mb-4 font-display font-medium tracking-sensual">
              Your Community <span className="text-neon-pink">•</span> Your Freedom <span className="text-neon-cyan">•</span> Your Connection
            </p>
            <p className="mt-6 max-w-3xl mx-auto text-lg text-steel-300 font-sans leading-relaxed">
      ...
      <section id="features" className="relative bg-ink-800 py-24">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="text-center mb-16">
            ...
            <h2 className="font-display text-4xl md:text-6xl font-semibold tracking-sensual text-white text-soft-glow-pink mb-4">
              Built Different
            </h2>
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h2 className="font-display text-4xl md:text-5xl font-semibold tracking-sensual text-white text-soft-glow-pink mb-6">
      ...
      <section className="relative bg-ink-800 py-24">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="text-center mb-12">
            <h2 className="font-display text-4xl md:text-5xl font-semibold tracking-sensual text-white text-soft-glow-cyan mb-4">
              Cross-Platform Advertising
            </h2>
            <p className="text-lg text-steel-300 max-w-2xl mx-auto leading-relaxed">
      ...
      <section className="relative bg-ink-900 py-24">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="text-center mb-12">
            ...
            <h2 className="font-display text-4xl md:text-6xl font-bold tracking-sensual text-white text-soft-glow-pink mb-4 drop-shadow-[0_2px_8px_rgba(0,0,0,0.9)]">
              40+ Platforms. One Ecosystem.
            </h2>
            <p className="text-lg text-steel-300 max-w-3xl mx-auto leading-relaxed drop-shadow-[0_2px_6px_rgba(0,0,0,0.8)]">
              From infrastructure to AI, commerce to community—everything flows through FanzOS.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-12">
            <div className="p-6 rounded-xl bg-ink-800/80 border-2 border-neon-pink/30 backdrop-blur-md text-center hover-lift transition-all duration-300">
              <div className="text-4xl mb-3">🧠</div>
              <h3 className="font-display text-xl font-semibold tracking-flow text-neon-pink mb-2 drop-shadow-[0_2px_6px_rgba(255,45,161,0.7)]">Core Brain</h3>
              <p className="text-sm text-steel-300 font-sans drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)]">9 infrastructure platforms</p>
            </div>

            <div className="p-6 rounded-xl bg-ink-800/80 border-2 border-neon-cyan/30 backdrop-blur-md text-center hover-lift transition-all duration-300">
              <div className="text-4xl mb-3">🎭</div>
              <h3 className="font-display text-xl font-semibold tracking-flow text-neon-cyan mb-2 drop-shadow-[0_2px_6px_rgba(25,240,255,0.7)]">Creator Verticals</h3>
              <p className="text-sm text-steel-300 font-sans drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)]">15+ niche platforms</p>
            </div>

            <div className="p-6 rounded-xl bg-ink-800/80 border-2 border-acid-lime/30 backdrop-blur-md text-center hover-lift transition-all duration-300">
              <div className="text-4xl mb-3">💬</div>
              <h3 className="font-display text-xl font-semibold tracking-flow text-acid-lime mb-2 drop-shadow-[0_2px_6px_rgba(200,255,61,0.7)]">Social Universe</h3>
              <p className="text-sm text-steel-300 font-sans drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)]">6 engagement tools</p>
            </div>

            <div className="p-6 rounded-xl bg-ink-800/80 border-2 border-uv-500/30 backdrop-blur-md text-center hover-lift transition-all duration-300">
              <div className="text-4xl mb-3">🤖</div>
              <h3 className="font-display text-xl font-semibold tracking-flow text-uv-500 mb-2 drop-shadow-[0_2px_6px_rgba(122,44,255,0.7)]">AI & Commerce</h3>
              <p className="text-sm text-steel-300 font-sans drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)]">12 smart systems</p>
            </div>
          </div>

          <div className="text-center">
            <ButtonPrimary href="/ecosystem">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="p-12 rounded-3xl bg-ink-800/80 border-2 border-acid-lime/30 backdrop-blur-md shadow-[0_0_40px_rgba(200,255,61,0.2)] text-center">
            ...
            <div className="relative z-10">
              ...
              <p className="text-lg text-steel-300 max-w-2xl mx-auto mb-8 leading-relaxed">
      ...
      <section className="relative bg-ink-800 py-24">
        ...
        <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
          <h2 className="font-display text-5xl md:text-8xl font-bold tracking-airy text-soft-glow-pink animate-flicker mb-6">
            Own Your World
          </h2>
