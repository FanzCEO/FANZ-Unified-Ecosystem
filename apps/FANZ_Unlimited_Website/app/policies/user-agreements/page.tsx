  ...
  const policies = [
    {
      ...
      description: 'Binding contract for Content Stars and Co-Stars including arbitration, prohibited content, and liability terms',
      ...
      <section className="relative overflow-hidden bg-ink-900 text-white">
        ...
        <div className="max-w-7xl mx-auto px-6 py-32">
          <div className="text-center">
            ...
            <BadgeUnderground className="mb-6">📝 Agreements</BadgeUnderground>
            ...
            <p className="text-steel-300 max-w-3xl mx-auto">
              Terms users agree to when using the platform
            </p>
          </div>
        </div>
