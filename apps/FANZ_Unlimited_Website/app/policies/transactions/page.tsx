...
export default function TransactionsPage() {
  const policies = [
    {
      title: 'Transaction & Chargeback Policy',
      description: 'Payment processing, refunds, chargebacks, creator payouts, and dispute resolution procedures',
      href: '/policies/transaction-chargeback',
      icon: '💳'
    }
  ];
      ...
      <section className="relative overflow-hidden bg-ink-900 text-white">
        ...
        <div className="max-w-7xl mx-auto px-6 py-32">
          <div className="text-center">
            ...
            <BadgeUnderground className="mb-6">💳 Financial Policies</BadgeUnderground>
            <h1 className="font-display text-5xl md:text-7xl text-glow neon-stroke animate-flicker mb-6">
              Transactions and Shop
            </h1>
            <p className="text-steel-300 max-w-3xl mx-auto">
              Payment processing, shop policies, and transaction management
            </p>
          </div>
        </div>
