  ...
  const policies = [
    {
      ...
      description: 'Crisis support, mental health, substance abuse recovery, LGBTQ+ resources, and wellness support',
      href: '/policies/healthcare-resources',
      icon: '🏥'
    }
  ];
      ...
      <section className="relative overflow-hidden bg-ink-900 text-white">
        ...
        <div className="max-w-7xl mx-auto px-6 py-32">
          <div className="text-center">
            ...
            <BadgeUnderground className="mb-6">🏥 Wellness & Support</BadgeUnderground>
            ...
            <p className="text-steel-300 max-w-3xl mx-auto">
              Health resources, crisis support, and wellness programs
            </p>
          </div>
        </div>
