  ...
  const policies = [
    {
      ...
      description: 'Taxation, KYC/KYB requirements, COPPA compliance, diversity & inclusion, and ethical standards',
      ...
      <section className="relative overflow-hidden bg-ink-900 text-white">
        ...
        <div className="max-w-7xl mx-auto px-6 py-32">
          <div className="text-center">
            ...
            <BadgeUnderground className="mb-6">🤝 Ethics & Standards</BadgeUnderground>
            <h1 className="font-display text-5xl md:text-7xl text-glow neon-stroke animate-flicker mb-6">
              Ethics, Diversity, Inclusion, Compliance
            </h1>
            <p className="text-steel-300 max-w-3xl mx-auto">
              Ethical standards, diversity policies, and compliance requirements
            </p>
          </div>
        </div>
