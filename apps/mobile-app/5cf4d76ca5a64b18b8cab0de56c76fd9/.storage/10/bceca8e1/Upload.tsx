...
export default function Upload({ onPageChange }: UploadProps) {
  ...
  const handleComplianceSubmit = (complianceData: any) => {
              ...
              <div className="space-y-2">
                {sourceOptions.slice(1).map((source) => (
                  <Button
                    ...
                    onClick={() => {
                      setMetadata({...metadata, source: source.value as any});
                      setUploadStep('metadata');
                    }}
                  >
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Select value={metadata.source} onValueChange={(value) => setMetadata({...metadata, source: value as any})}>
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
