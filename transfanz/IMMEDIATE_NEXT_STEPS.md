...
Pick one platform to start with (recommend **TransFanz** for the dark theme):
```bash
./start-TransFanz.sh
...
### **Frontend:**
- Start with one platform (TransFanz recommended)
