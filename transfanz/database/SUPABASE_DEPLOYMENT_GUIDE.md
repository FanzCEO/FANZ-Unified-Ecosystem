# TransFanz Database - Supabase Deployment Guide
...
2. **Execute the Complete Schema**
   - Click **"New Query"**
   - Open the file: `/tmp/TransFanzV1/database/complete-schema.sql`
...
Update your `/tmp/TransFanzV1/.env` file:
...
Your TransFanzV1 project uses Drizzle ORM. After manual SQL deployment:
...
VALUES ('admin', 'admin@TransFanz.com', '$2a$10$...', true, true);
...
- TransFanzV1 Repo: https://github.com/FanzCEO/TransFanzV1

---

## Deployment Status

**Schema File**: `/tmp/TransFanzV1/database/complete-schema.sql`
**Total Lines**: 3,477
