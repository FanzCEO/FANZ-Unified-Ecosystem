...
Pick one platform to start with (recommend **TabooFanz** for the dark theme):
```bash
./start-TabooFanz.sh
...
### **Frontend:**
- Start with one platform (TabooFanz recommended)
