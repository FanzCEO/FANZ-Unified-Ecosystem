...
#### Core Platforms
- **TabooFanz** (`TabooFanz.com`) - Port 5001 - Men's content platform
...
TabooFanz_SERVICE_URL=http://localhost:5001
...
### TabooFanz Server Integration
The gateway is integrated into the main TabooFanz server via:
...
### Local Development
1. Start TabooFanz server: `npm run dev`
...
🌐 **Multi-Platform**: Support for all FANZ platforms (TabooFanz, GirlFanz, etc.)  
