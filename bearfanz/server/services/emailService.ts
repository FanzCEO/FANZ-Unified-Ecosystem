...
const FROM_EMAIL = 'BearFanz <onboarding@resend.dev>'; // Change to your verified domain
  ...
  async sendVerificationEmail(email: string, token: string): Promise<void> {
    ...
    const html = `
      ...
      <html>
        ...
        <body>
          ...
          <div class="footer">
            <p>If you didn't create an account with BearFanz, you can safely ignore this email.</p>
            <p>&copy; ${new Date().getFullYear()} BearFanz. All rights reserved.</p>
          </div>
        </body>
      </html>
    `;
    ...
    try {
      await resend.emails.send({
        from: FROM_EMAIL,
        to: email,
        subject: 'Verify your BearFanz account',
        html,
      });
  ...
  async sendPasswordResetEmail(email: string, token: string): Promise<void> {
    ...
    try {
      await resend.emails.send({
        from: FROM_EMAIL,
        to: email,
        subject: 'Reset your BearFanz password',
        html,
      });
