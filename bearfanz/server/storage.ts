...
export class DatabaseStorage implements IStorage {
  ...
  async anonymizeUserData(userId: string): Promise<void> {
    ...
    await db.update(users)
      .set({
        email: `deleted_user_${userId}@BearFanz.com`,
  ...
  async getSystemSetting(key: string): Promise<any | undefined> {
    ...
    const settings: { [key: string]: any } = {
      'app_name': { key: 'app_name', value: 'BearFanz', type: 'string' },
  ...
  async getEmailSettings(): Promise<any> {
    return {
      ...
      smtpPort: 587,
      smtpUsername: 'noreply@BearFanz.com',
      smtpPassword: '****',
      smtpSecure: true,
      fromEmail: 'noreply@BearFanz.com',
      fromName: 'BearFanz',
      replyToEmail: 'support@BearFanz.com',
      maxSendRate: 100,
      isActive: true,
