...
#### Core Platforms
- **BearFanz** (`BearFanz.com`) - Port 5001 - Men's content platform
...
BearFanz_SERVICE_URL=http://localhost:5001
...
### BearFanz Server Integration
The gateway is integrated into the main BearFanz server via:
...
### Local Development
1. Start BearFanz server: `npm run dev`
...
🌐 **Multi-Platform**: Support for all FANZ platforms (BearFanz, GirlFanz, etc.)  
