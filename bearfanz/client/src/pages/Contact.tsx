...
const FAQ = () => {
  const faqs = [
    ...
    },
    {
      ...
      answer: "BearFanz operates on a 100% creator earnings program - we take 0% platform fees. You only pay standard payment processing fees (around 2.9%)."
    },
    {
          ...
          <div className="space-y-6">
            ...
            <Card>
              ...
              <CardContent className="space-y-2">
                <p className="text-sm">BearFanz HQ</p>
