...
class BearFanzOfflineStorage {
  private db: IDBDatabase | null = null;
  private readonly dbName = 'BearFanzPWA';
  ...
  async initDB(): Promise<void> {
    return new Promise((resolve, reject) => {
      ...
      request.onsuccess = () => {
        ...
        console.log('✅ BearFanz IndexedDB initialized');
        resolve();
      };
...
export const offlineStorage = new BearFanzOfflineStorage();
