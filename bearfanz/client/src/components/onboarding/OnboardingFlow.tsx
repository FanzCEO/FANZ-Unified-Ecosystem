    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4" data-testid="onboarding-flow">
      <div className="w-full max-w-2xl">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-display font-bold text-primary tracking-wider mb-2">BearFanz</h1>
    ...
    <div className="text-center space-y-6">
      ...
      <div className="space-y-4">
        ...
        <p className="text-muted-foreground font-body text-lg max-w-lg mx-auto">
          BearFanz isn't just another platform - it's <span className="text-primary font-semibold">Every Man's Playground</span> where 
    ...
    <div className="text-center space-y-6">
      ...
      <div className="space-y-4">
        ...
        <p className="text-lg text-muted-foreground max-w-md mx-auto">
          Your kingdom awaits. Time to show the world what you're made of and build your empire on BearFanz.
        </p>
