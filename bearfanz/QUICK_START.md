...
- 5 registered domains (BearFanz.com, girlfanz.com, pupfanz.com, transfanz.com, taboofanz.com)
...
|--------|------|------|-------|
| BearFanz.com | A | @ | `<LOAD_BALANCER_IP>` |
| BearFanz.com | A | www | `<LOAD_BALANCER_IP>` |
...
- **GitHub Issues**: https://github.com/FanzCEO/BearFanzV1/issues
