...
- PostgreSQL database
- Redis cache
- All 5 platforms (BearFanz, GirlFanz, PupFanz, TransFanz, TabooFanz)
- NGINX load balancer
...
- `k8s/deployments/BearFanz-deployment.yaml` - 3 replicas
...
#### **Services** (ClusterIP)
- `k8s/services/BearFanz-service.yaml`
...
- GitHub: https://github.com/FanzCEO/BearFanzV1
