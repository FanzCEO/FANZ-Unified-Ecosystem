...
Pick one platform to start with (recommend **BearFanz** for the dark theme):
```bash
./start-BearFanz.sh
...
### **Frontend:**
- Start with one platform (BearFanz recommended)
