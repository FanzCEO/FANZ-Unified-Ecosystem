...
export class DatabaseStorage implements IStorage {
  ...
  async anonymizeUserData(userId: string): Promise<void> {
    ...
    await db.update(users)
      .set({
        email: `deleted_user_${userId}@southernfanz.com`,
  ...
  async getSystemSetting(key: string): Promise<any | undefined> {
    ...
    const settings: { [key: string]: any } = {
      'app_name': { key: 'app_name', value: 'SouthernFanz', type: 'string' },
  ...
  async getEmailSettings(): Promise<any> {
    return {
      ...
      smtpPort: 587,
      smtpUsername: 'noreply@southernfanz.com',
      smtpPassword: '****',
      smtpSecure: true,
      fromEmail: 'noreply@southernfanz.com',
      fromName: 'SouthernFanz',
      replyToEmail: 'support@southernfanz.com',
      maxSendRate: 100,
      isActive: true,
