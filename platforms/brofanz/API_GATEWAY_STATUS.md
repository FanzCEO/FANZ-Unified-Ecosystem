...
#### Core Platforms
- **BroFanz** (`brofanz.com`) - Port 5001 - Men's content platform
...
BROFANZ_SERVICE_URL=http://localhost:5001
...
### BroFanz Server Integration
The gateway is integrated into the main BroFanz server via:
...
### Local Development
1. Start BroFanz server: `npm run dev`
...
🌐 **Multi-Platform**: Support for all FANZ platforms (BroFanz, GirlFanz, etc.)  
