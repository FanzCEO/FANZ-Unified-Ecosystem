...
class BroFanzOfflineStorage {
  private db: IDBDatabase | null = null;
  private readonly dbName = 'BroFanzPWA';
  ...
  async initDB(): Promise<void> {
    return new Promise((resolve, reject) => {
      ...
      request.onsuccess = () => {
        ...
        console.log('✅ BroFanz IndexedDB initialized');
        resolve();
      };
...
export const offlineStorage = new BroFanzOfflineStorage();
