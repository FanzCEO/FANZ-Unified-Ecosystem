...
export class DatabaseStorage implements IStorage {
  ...
  async anonymizeUserData(userId: string): Promise<void> {
    ...
    await db.update(users)
      .set({
        email: `deleted_user_${userId}@brofanz.com`,
  ...
  async getSystemSetting(key: string): Promise<any | undefined> {
    ...
    const settings: { [key: string]: any } = {
      'app_name': { key: 'app_name', value: 'BroFanz', type: 'string' },
  ...
  async getEmailSettings(): Promise<any> {
    return {
      ...
      smtpPort: 587,
      smtpUsername: 'noreply@brofanz.com',
      smtpPassword: '****',
      smtpSecure: true,
      fromEmail: 'noreply@brofanz.com',
      fromName: 'BroFanz',
      replyToEmail: 'support@brofanz.com',
      maxSendRate: 100,
      isActive: true,
