# BroFanz Database - Supabase Deployment Guide
...
2. **Execute the Complete Schema**
   - Click **"New Query"**
   - Open the file: `/tmp/BroFanzV1/database/complete-schema.sql`
...
Update your `/tmp/BroFanzV1/.env` file:
...
Your BroFanzV1 project uses Drizzle ORM. After manual SQL deployment:
...
VALUES ('admin', 'admin@brofanz.com', '$2a$10$...', true, true);
...
- BroFanzV1 Repo: https://github.com/FanzCEO/BroFanzV1

---

## Deployment Status

**Schema File**: `/tmp/BroFanzV1/database/complete-schema.sql`
**Total Lines**: 3,477
