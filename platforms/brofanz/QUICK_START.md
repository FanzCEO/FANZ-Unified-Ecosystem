...
- 5 registered domains (brofanz.com, girlfanz.com, pupfanz.com, transfanz.com, taboofanz.com)
...
|--------|------|------|-------|
| brofanz.com | A | @ | `<LOAD_BALANCER_IP>` |
| brofanz.com | A | www | `<LOAD_BALANCER_IP>` |
...
- **GitHub Issues**: https://github.com/FanzCEO/BroFanzV1/issues
