...
- PostgreSQL database
- Redis cache
- All 5 platforms (BroFanz, GirlFanz, PupFanz, TransFanz, TabooFanz)
- NGINX load balancer
...
- `k8s/deployments/brofanz-deployment.yaml` - 3 replicas
...
#### **Services** (ClusterIP)
- `k8s/services/brofanz-service.yaml`
...
- GitHub: https://github.com/FanzCEO/BroFanzV1
