...
## TL;DR - BroFanz Platform Backend (FANZ Ecosystem)

**BroFanz-3** is a production-ready Node.js/TypeScript backend serving the BroFanz adult content creator platform (`brofanz.com`). Built as part of the FANZ Unlimited Network ecosystem with API Gateway, multi-cloud infrastructure, adult-friendly payment processing, real-time monitoring, and mobile backend (ClubCentral app) support.
...
```
[Web/App (BroFanz)]  [FanzClub/ClubCentral]  [Creator Studio]  [Fan Dash]
                \         |                    |                /
                              [ API Gateway / Edge ]
                                       |
                            [ Feature Flags / AB ]
...
- **BroFanz**: `brofanz.com` (primary platform)
...
OTEL_SERVICE_NAME=brofanz-web
OTEL_EXPORTER_OTLP_ENDPOINT=https://otel-collector.example.com:4317

# Storage & CDN
CDN_BASE=https://cdn.brofanz.com
STORAGE_BUCKET=brofanz-media
...
export OTEL_SERVICE_NAME="brofanz-web"
...
### Required Ad Placements (BroFanz)
```bash
...
- **Developer APIs**: https://developers.brofanz.com
- **Status Monitoring**: https://status.brofanz.com
