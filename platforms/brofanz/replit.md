# BroFanz-3 - FANZ Unlimited Network Ecosystem

## Overview

BroFanz-3 is the flagship platform of the FANZ Unlimited Network, a multi-platform adult content creator economy ecosystem. This Node.js/TypeScript backend powers BroFanz.com and serves as the foundation for the broader FANZ network, which includes GirlFanz, PupFanz, TransFanz, and TabooFanz platforms.
...
- BroFanz (Port 5001) - Men's content platform
...
2. Configure custom domain DNS:
   - Testing: `fanz.brofanz.com`
   - Production: `BroFanz.com`
...
- ✅ **Kubernetes Configs** - Full k8s deployment for Digital Ocean:
  - Deployments for all 5 platforms (BroFanz, GirlFanz, PupFanz, TransFanz, TabooFanz)
