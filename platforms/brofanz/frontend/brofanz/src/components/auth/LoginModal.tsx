      ...
      <div className="space-y-6">
        ...
        <div className="bg-background/50 p-4 rounded-lg border border-border">
          ...
          <div className="space-y-1 text-sm text-text-secondary">
            <div><strong>Admin:</strong> admin@brofanz.com / admin123</div>
            <div><strong>Creator:</strong> creator@brofanz.com / creator123</div>
            <div><strong>Fan:</strong> fan@brofanz.com / fan123</div>
          </div>
        </div>
