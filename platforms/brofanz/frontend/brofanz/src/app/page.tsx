          ...
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-sm text-text-secondary font-body">
                Where Bros Run The Creator Economy
              </span>
            </div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            <h1 className="text-6xl md:text-8xl font-heading text-primary underground-glow mb-6 leading-none">
              WHERE BROS
              <br />
              <span className="text-secondary">RUN THE GAME</span>
            </h1>
            <p className="text-xl md:text-2xl text-text-secondary mb-8 max-w-3xl mx-auto font-body">
              Welcome to BroFanz. The home for gym bros, jocks, gamers, athletes, and every guy with a chill, confident vibe.
              Join the brotherhood of creators and fans who keep it real.
            </p>
      ...
      <footer className="bg-background border-t border-border py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              <h3 className="text-lg font-heading text-primary underground-glow mb-4">BroFanz</h3>
              <p className="text-text-secondary text-sm">
                Where the bros come to run the creator economy. The home for gym bros, jocks, athletes, and everyday dudes.
              </p>
            </div>
            <div>
          ...
          <div className="border-t border-border mt-12 pt-8 text-center text-sm text-text-secondary">
            <p>© 2025 BroFanz. Where the bros come to run the creator economy. 18+ Only.</p>
          </div>
        </div>
      </footer>
