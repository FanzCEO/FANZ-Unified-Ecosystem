# BroFanz Complete Database Schema - Quick Start Guide
...
**Location**: `/tmp/BroFanzV1/database/complete-schema.sql`
- **Size**: 124 KB
- **Lines**: 3,477
...
**Location**: `/tmp/BroFanzV1/database/README.md`
...
createdb brofanz_production
```

#### Step 2: Execute Schema
```bash
# Navigate to database directory
cd /tmp/BroFanzV1/database

# Execute the complete schema
psql brofanz_production < complete-schema.sql
```

#### Step 3: Verify Tables
```bash
# Connect to database
psql brofanz_production
...
2. Click "New Project"
3. Enter project name: "brofanz-production"
4. Set database password
5. Select region closest to your users

#### Step 2: Execute Schema
1. Open SQL Editor in Supabase dashboard
2. Copy entire contents of `/tmp/BroFanzV1/database/complete-schema.sql`
...
```bash
# Your BroFanzV1 project already has Drizzle configured!
cd /tmp/BroFanzV1

# Set database URL in .env
echo "DATABASE_URL=postgresql://user:password@host:5432/brofanz_production" > .env
...
```
/tmp/BroFanzV1/database/complete-schema.sql
```
...
Simply copy `/tmp/BroFanzV1/database/complete-schema.sql` and paste it into your PostgreSQL database or Supabase SQL editor to get started!
