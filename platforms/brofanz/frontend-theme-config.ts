...
export const PLATFORM_THEMES: Record<string, PlatformTheme> = {
  brofanz: {
    ...
    domain: 'brofanz.com',
    colors: {
      primary: '#0099ff',        // Electric blue (sport energy)
      secondary: '#00ff88',      // Neon lime (cyber cyan)
      accent: '#ffffff',         // White
      background: '#0d0d0d',     // Deep charcoal black (bro-bg)
      surface: '#1e1e1e',       // Concrete gray/steel (bro-surface)
      text: '#ffffff',          // White text
      textSecondary: '#b0b0b0',  // Light gray
      border: '#3a3a3a',        // Matte iron (bro-border)
      success: '#00cc66',       // Turf green (sports field vibe)
      warning: '#ffaa00',       // Orange
      error: '#ff3333',         // Hot red (bro-danger)
      info: '#00aaff'           // Blue
    },
    fonts: {
    ...
    shadows: {
      sm: '0 2px 4px rgba(0, 153, 255, 0.1)',
      md: '0 4px 8px rgba(0, 153, 255, 0.2)',
      lg: '0 8px 16px rgba(0, 153, 255, 0.3)',
      xl: '0 16px 32px rgba(0, 153, 255, 0.4)'
    },
    animations: {
      fast: '150ms ease',
      normal: '300ms ease',
...
export const BroFanzTheme = PLATFORM_THEMES.brofanz
