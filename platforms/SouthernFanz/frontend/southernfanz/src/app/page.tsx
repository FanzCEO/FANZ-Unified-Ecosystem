        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            <h1 className="text-6xl md:text-8xl font-heading text-primary underground-glow mb-6 leading-none">
              RAISE HELL
              <br />
              <span className="text-secondary">RIDE FREE</span>
            </h1>
            <p className="text-xl md:text-2xl text-text-secondary mb-8 max-w-3xl mx-auto font-body">
              Where Southern bad boys and girls run wild. No rules. No limits.
              Join the rebellion of creators and fans who don&apos;t play it safe.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-text-secondary max-w-2xl mx-auto">
              Run with the wildest rebels south of the Mason-Dixon. This ain&apos;t your average crew.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-surface p-8 rounded-lg neon-border hover:shadow-red-glow transition-all">
              ...
              <h3 className="text-xl font-heading text-text mb-3">Ride-or-Die Community</h3>
              <p className="text-text-secondary">
                Connect with your people. No fake BS, no judgment - just real rebels being real.
              </p>
            </div>
            ...
            <div className="bg-surface p-8 rounded-lg neon-border hover:shadow-red-glow transition-all">
              ...
              <h3 className="text-xl font-heading text-text mb-3">Uncut Content</h3>
              <p className="text-text-secondary">
                Raw, wild, unfiltered. The content you won&apos;t find anywhere else from creators who don&apos;t hold back.
              </p>
            </div>
            ...
            <div className="bg-surface p-8 rounded-lg neon-border hover:shadow-red-glow transition-all">
              ...
              <h3 className="text-xl font-heading text-text mb-3">Live & Loaded</h3>
              <p className="text-text-secondary">
                Real-time chaos. Private shows, live streams, and exclusive access when the sun goes down.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-surface">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl text-text-secondary mb-8">
            The South&apos;s calling. Bad boys and girls are already riding - you coming or what?
          </p>
          <Link href="/explore" className="inline-block">
      ...
      <footer className="bg-background border-t border-border py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              <h3 className="text-lg font-heading text-primary underground-glow mb-4">SouthernFanz</h3>
              <p className="text-text-secondary text-sm">
                Raise Hell. Ride Free. The rebellion for Southern bad boys and girls who don&apos;t follow rules.
              </p>
            </div>
            <div>
          ...
          <div className="border-t border-border mt-12 pt-8 text-center text-sm text-text-secondary">
            <p>© 2025 SouthernFanz. Raise Hell. Ride Free. 18+ Only.</p>
          </div>
        </div>
      </footer>
