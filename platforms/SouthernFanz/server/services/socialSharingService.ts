...
class SocialSharingService {
  ...
  private async generateShareContent(content: any, template: SocialShareTemplate, customizations?: any): Promise<{
    ...
    const shareUrl = `https://share.southernfanz.com/${content.id}/${template.id}`;
    const previewUrl = `https://cdn.southernfanz.com/previews/social_${Date.now()}.jpg`;
