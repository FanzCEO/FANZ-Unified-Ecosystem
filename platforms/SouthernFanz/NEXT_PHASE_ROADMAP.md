...
**Deliverables:**
- [ ] **SouthernFanz.com** - Dark underground aesthetic
...
// FANZ Design System
{
  ...
  "themes": {
    "SouthernFanz": "Dark underground with blood-red neon",
...
### 🔥 SouthernFanz.com - "Every Man's Playground"
...
2. **Initialize Platform Projects**
   ...
   npx create-next-app@latest apps/southernfanz --typescript --tailwind
