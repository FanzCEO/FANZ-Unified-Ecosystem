# SouthernFanz Database - Supabase Deployment Guide
...
2. **Execute the Complete Schema**
   - Click **"New Query"**
   - Open the file: `/tmp/SouthernFanzV1/database/complete-schema.sql`
...
Update your `/tmp/SouthernFanzV1/.env` file:
...
Your SouthernFanzV1 project uses Drizzle ORM. After manual SQL deployment:
...
VALUES ('admin', 'admin@southernfanz.com', '$2a$10$...', true, true);
...
- SouthernFanzV1 Repo: https://github.com/FanzCEO/SouthernFanzV1

---

## Deployment Status

**Schema File**: `/tmp/SouthernFanzV1/database/complete-schema.sql`
**Total Lines**: 3,477
...
**SouthernFanzV1 Database Schema**
