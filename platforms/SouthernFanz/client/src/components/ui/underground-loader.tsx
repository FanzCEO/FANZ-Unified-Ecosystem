      ...
      <div className="relative z-10">
        ...
        <div className="text-center mt-8 space-y-4">
          ...
          <div className="text-gray-400 text-sm tracking-wide">
            {progress < 30 && "🔥 Firing up the engine..."}
            {progress >= 30 && progress < 60 && "🥃 Pouring some whiskey..."}
            {progress >= 60 && progress < 90 && "🏍️ Revving up the hogs..."}
            {progress >= 90 && "⚡ Welcome to SouthernFanz - Let's Raise Hell"}
          </div>
        </div>
      </div>
