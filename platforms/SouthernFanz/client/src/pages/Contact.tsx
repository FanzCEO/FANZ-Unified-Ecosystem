...
const FAQ = () => {
  const faqs = [
    ...
    },
    {
      ...
      answer: "SouthernFanz operates on a 100% creator earnings program - we take 0% platform fees. You only pay standard payment processing fees (around 2.9%)."
    },
    {
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          ...
          <ContactMethod
            ...
            action="support@southernfanz.com"
            available={true}
          />
          <ContactMethod
            icon={Phone}
          ...
          <div className="space-y-6">
            ...
            <Card>
              ...
              <CardContent className="space-y-2">
                <p className="text-sm">SouthernFanz HQ</p>
