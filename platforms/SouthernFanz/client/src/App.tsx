    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-background">
        <div className="text-center">
          ...
          <p className="text-muted-foreground">Loading SouthernFanz...</p>
        </div>
      </div>
    );
  }
  ...
  if (!isAuthenticated) {
    return (
      <Switch>
        ...
        {/* Co-Star Verification (public - doesnt require login) */}
