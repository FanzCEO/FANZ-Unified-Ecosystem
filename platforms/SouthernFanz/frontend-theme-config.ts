...
export const PLATFORM_THEMES: Record<string, PlatformTheme> = {
  southernfanz: {
    ...
    slogan: 'Raise Hell. Ride Free.',
    domain: 'southernfanz.com',
    colors: {
      primary: '#dc2626',        // Rebel red - like a muscle car
      secondary: '#b8860b',      // Bourbon gold - whiskey tones
      accent: '#f5f5dc',         // Weathered white - like worn leather
      background: '#0d0d0d',     // Midnight black - backroad darkness
      surface: '#1c1917',        // Charcoal smoke - bonfire ash
      text: '#fafaf9',           // Moonshine white
      textSecondary: '#a8a29e',  // Dusty trail gray
      border: '#44403c',         // Rust iron
      success: '#22c55e',        // Money green
      warning: '#f59e0b',        // Caution amber
      error: '#ef4444',          // Hellfire red
...
export const SouthernFanzTheme = PLATFORM_THEMES.southernfanz
