...
PROJECT_ROOT="/Users/joshuastone/Downloads/SouthernFanz-3"
  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        southernfanz: "bg-[#ff0000] text-white hover:bg-[#ff0000]/90 shadow-md hover:shadow-lg font-bold",
...
const Card = React.forwardRef<
  ...
  React.HTMLAttributes<HTMLDivElement> & {
    platform?: 'southernfanz' | 'girlfanz' | 'pupfanz' | 'transfanz' | 'taboofanz'
  }
>(({ className, platform, ...props }, ref) => {
  const platformStyles = {
    southernfanz: "bg-[#1a1a1a] border-[#333333] shadow-lg hover:shadow-[0_8px_16px_rgba(255,0,0,0.3)]",
...
>(({ className, platform, ...props }, ref) => {
  const platformFonts = {
    southernfanz: "font-['Bebas_Neue'] text-white",
...
const Input = React.forwardRef<HTMLInputElement, InputProps>(
  ({ className, type, platform, ...props }, ref) => {
    const platformStyles = {
      southernfanz: "bg-[#1a1a1a] border-[#333333] text-white placeholder:text-[#888888] focus:border-[#ff0000] focus:ring-[#ff0000]",
...
>(({ className, platform, ...props }, ref) => {
  const platformStyles = {
    southernfanz: "ring-2 ring-[#ff0000]",
...
>(({ className, platform, ...props }, ref) => {
  const platformStyles = {
    southernfanz: "bg-[#1a1a1a] text-[#ff0000]",
  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        // Platform-specific variants
        southernfanz: "border-transparent bg-[#ff0000] text-white hover:bg-[#ff0000]/80 shadow-sm",
...
export type Platform = 'southernfanz' | 'girlfanz' | 'pupfanz' | 'transfanz' | 'taboofanz'
...
export function useCurrentPlatform(): Platform {
  ...
  return (process.env.NEXT_PUBLIC_PLATFORM as Platform) || 'southernfanz'
}
EOF
...
main() {
    ...
    echo "- southernfanz: Dark underground aesthetic"
