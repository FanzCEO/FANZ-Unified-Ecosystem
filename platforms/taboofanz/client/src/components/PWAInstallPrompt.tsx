// TabooFanz PWA Installation Prompt Component
// Custom installation prompt with TabooFanz underground aesthetic
  ...
  const handleInstall = async () => {
    ...
    try {
      ...
      if (success) {
        ...
        console.log('🎉 TabooFanz PWA installed successfully');
      }
    } catch (error) {
