...
export class DatabaseStorage implements IStorage {
  ...
  async anonymizeUserData(userId: string): Promise<void> {
    ...
    await db.update(users)
      .set({
        email: `deleted_user_${userId}@taboofanz.com`,
  ...
  async getSystemSetting(key: string): Promise<any | undefined> {
    ...
    const settings: { [key: string]: any } = {
      'app_name': { key: 'app_name', value: 'TabooFanz', type: 'string' },
  ...
  async getEmailSettings(): Promise<any> {
    return {
      ...
      smtpPort: 587,
      smtpUsername: 'noreply@taboofanz.com',
      smtpPassword: '****',
      smtpSecure: true,
      fromEmail: 'noreply@taboofanz.com',
      fromName: 'TabooFanz',
      replyToEmail: 'support@taboofanz.com',
      maxSendRate: 100,
      isActive: true,
