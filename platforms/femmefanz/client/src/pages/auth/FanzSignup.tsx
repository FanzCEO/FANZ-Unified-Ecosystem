      ...
      {registerMutation.isPending && (
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center">
          <div className="text-center space-y-4">
            <div className="w-16 h-16 border-4 border-[#d4a959] border-t-transparent rounded-full animate-spin mx-auto" />
            <div className="space-y-2">
              <h3 className="text-2xl font-['Bebas_Neue'] text-white">Creating Your Account</h3>
              <p className="text-zinc-400">Please wait while we set up your profile...</p>
            </div>
          </div>
        </div>
      )}
