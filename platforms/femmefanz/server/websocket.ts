...
// ============================================================================
// SINGLETON INSTANCE - COMMENTED OUT TO PREVENT AUTO-INITIALIZATION
// ============================================================================
// The WebSocket server should be initialized explicitly by the main server
// when it's ready, not as a module-level singleton.
//
// DO NOT UNCOMMENT THIS LINE - it causes port conflicts!

// Instead, export the class so it can be instantiated when needed:
