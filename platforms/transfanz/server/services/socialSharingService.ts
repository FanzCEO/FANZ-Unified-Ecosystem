...
class SocialSharingService {
  ...
  private async generateShareContent(content: any, template: SocialShareTemplate, customizations?: any): Promise<{
    ...
    const shareUrl = `https://share.transfanz.com/${content.id}/${template.id}`;
    const previewUrl = `https://cdn.transfanz.com/previews/social_${Date.now()}.jpg`;
