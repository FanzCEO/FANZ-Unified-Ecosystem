...
export class DatabaseStorage implements IStorage {
  ...
  async anonymizeUserData(userId: string): Promise<void> {
    ...
    await db.update(users)
      .set({
        email: `deleted_user_${userId}@transfanz.com`,
  ...
  async getSystemSetting(key: string): Promise<any | undefined> {
    ...
    const settings: { [key: string]: any } = {
      'app_name': { key: 'app_name', value: 'TransFanz', type: 'string' },
  ...
  async getEmailSettings(): Promise<any> {
    return {
      ...
      smtpPort: 587,
      smtpUsername: 'noreply@transfanz.com',
      smtpPassword: '****',
      smtpSecure: true,
      fromEmail: 'noreply@transfanz.com',
      fromName: 'TransFanz',
      replyToEmail: 'support@transfanz.com',
      maxSendRate: 100,
      isActive: true,
