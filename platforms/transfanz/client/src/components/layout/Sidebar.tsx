      ...
      <div className="flex h-16 md:h-20 items-center px-4 md:px-6 border-b border-border">
        <div className="flex items-center gap-2 md:gap-3">
          ...
          <div className="flex flex-col">
            <span className="font-display font-bold text-lg md:text-xl neon-sign tracking-wider">TransFanz</span>
            <span className="text-xs neon-sign-golden font-heading font-semibold tracking-wide uppercase hidden sm:block">Embrace Your True Self</span>
          </div>
        </div>
      </div>
